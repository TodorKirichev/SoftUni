...
import softuni.exam.models.dto.imports.OfferSeedRootDto;
    ...
    public String importOffers() throws IOException, JAXBException {
        ...
        offerSeedRootDto.getOffers().stream()
                .filter(offerSeedDto -> {
                    ...
                    if (isValid) {
                        sb.append(String.format("Successfully import offer %s - %s",offerSeedDto.getAddedOn(), offerSeedDto.isHasGoldStatus()))
                    ...
                    offer.setCar(carService.findId(offerSeedDto.getCar().getId()));
                    offer.setSeller(sellerService.findId(offerSeedDto.getSeller().getId()));
