package exercisespringdataautomappingobjects.exercisespringdataautomappingobjects.config;
    ...
    public ModelMapper modelMapper() {
        ...
        Converter<String, LocalDate> localDateConverter = new Converter<String, LocalDate>() {
            ...
            public LocalDate convert(MappingContext<String, LocalDate> mappingContext) {
                return mappingContext.getSource() == null ? LocalDate.now() : LocalDate.parse(mappingContext.getSource(), DateTimeFormatter.ofPattern("dd-MM-yyyy"));
            }
        };
