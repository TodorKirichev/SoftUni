package SoftUni.JavaAdvanced.OOP.ReflectionExercises._3_BarracksWars.data;
...
public class UnitRepository implements Repository {
	...
	public void removeUnit(String unitType) {
		Integer countOfUnits = amountOfUnits.get(unitType);
		if (countOfUnits == null || countOfUnits <= 0) {
			amountOfUnits.remove(unitType);
			throw new IllegalArgumentException("No such units in repository.");
		}
		amountOfUnits.put(unitType,--countOfUnits);
	}
}
