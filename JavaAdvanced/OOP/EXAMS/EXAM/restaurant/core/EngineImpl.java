...
import SoftUni.JavaAdvanced.OOP.EXAMS.EXAM.restaurant.common.Command;
...
public class EngineImpl implements Engine {
    ...
    private String addWaiter(String[] data) {
        return controller.addWaiter(data[0], data[1]);
    }
    ...
    private String removeWaiter(String[] data) {
        return controller.removeWaiter(data[0]);
    }

    private String removeClient(String[] data) {
        return controller.removeClient(data[0]);
    }

    private String startWorking(String[] data) {
        return controller.startWorking(data[0]);
    }
