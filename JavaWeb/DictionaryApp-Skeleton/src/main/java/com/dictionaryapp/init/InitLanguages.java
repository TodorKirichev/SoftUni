...
public class InitLanguages implements CommandLineRunner {
    ...
    private final Map<LanguageEnum, String> languageDescription = Map.of(
    ...
    public void run(String... args) throws Exception {
        ...
        languageDescription.forEach((name, description) -> {
            languageRepository.save(new Language(name, description));
        });
    }
}
